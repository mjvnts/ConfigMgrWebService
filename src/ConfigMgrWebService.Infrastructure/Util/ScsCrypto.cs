...
namespace ConfigMgrWebService.Infrastructure.Util;
...
public class ScsCrypto
{
    ...
    {
        var password = new Rfc2898DeriveBytes(key, Encoding.UTF8.GetBytes(salt), 10000, HashAlgorithmName.SHA256);
    ...
    /// <summary>
    /// Encrypts text using the key set by the constructor.
    /// </summary>
    ...
    /// <summary>
    /// Decrypts text using the key set by the constructor.
    /// </summary>
    ...
    /// <summary>
    /// Creates a SHA256 hash from the key and combines it with the SALT value.
    /// </summary>
    /// <param name="key">The key for encryption.</param>
